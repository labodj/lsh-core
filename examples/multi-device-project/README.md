...
- `J1_release`: leaner profile with local behavior and no network-click actions
- `J2_release`: profile with network-click actions enabled
...
4. Keep the topic, codec and serial choices close to the example until the first
