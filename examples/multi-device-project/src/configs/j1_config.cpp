 ...
 * @brief   Example device configuration for the J1 profile in the multi-device lsh-core sample.
 *
...
void Configurator::configure()
{
    ...
    // Secondary actuators
    btn1.addActuatorLong(getIndex(rel1)).addActuatorLong(getIndex(rel2));
    btn2.addActuatorLong(getIndex(rel2)).addActuatorLong(getIndex(rel1));
    btn4.addActuatorLong(getIndex(rel4)).addActuatorLong(getIndex(rel5));
    btn5.addActuatorLong(getIndex(rel5)).addActuatorLong(getIndex(rel4));
    btn6.addActuatorLong(getIndex(rel6)).addActuatorLong(getIndex(rel4)).addActuatorLong(getIndex(rel5));
    btn7.addActuatorLong(getIndex(rel7)).addActuatorSuperLong(getIndex(rel1)).addActuatorSuperLong(getIndex(rel2));
