...
#ifndef LSH_CORE_UTIL_CONSTANTS_TIMING_HPP
#define LSH_CORE_UTIL_CONSTANTS_TIMING_HPP
...
#define LSH_EFFECTIVE_ACTUATOR_DEBOUNCE_TIME_MS 100U
#else
#define LSH_EFFECTIVE_ACTUATOR_DEBOUNCE_TIME_MS CONFIG_ACTUATOR_DEBOUNCE_TIME_MS
static_assert(CONFIG_ACTUATOR_DEBOUNCE_TIME_MS >= 0, "CONFIG_ACTUATOR_DEBOUNCE_TIME_MS must be non-negative.");
static_assert(CONFIG_ACTUATOR_DEBOUNCE_TIME_MS <= UINT8_MAX, "CONFIG_ACTUATOR_DEBOUNCE_TIME_MS must fit in uint8_t.");
#endif  // CONFIG_ACTUATOR_DEBOUNCE_TIME_MS
static constexpr const uint8_t ACTUATOR_DEBOUNCE_TIME_MS =
    LSH_EFFECTIVE_ACTUATOR_DEBOUNCE_TIME_MS;  //!< Actuator debounce (min time between switches)
...
#else
static_assert(CONFIG_CLICKABLE_DEBOUNCE_TIME_MS >= 0, "CONFIG_CLICKABLE_DEBOUNCE_TIME_MS must be non-negative.");
static_assert(CONFIG_CLICKABLE_DEBOUNCE_TIME_MS <= UINT8_MAX, "CONFIG_CLICKABLE_DEBOUNCE_TIME_MS must fit in uint8_t.");
...
#else
static_assert(CONFIG_CLICKABLE_SCAN_INTERVAL_MS > 0, "CONFIG_CLICKABLE_SCAN_INTERVAL_MS must be greater than zero.");
static_assert(CONFIG_CLICKABLE_SCAN_INTERVAL_MS <= UINT16_MAX, "CONFIG_CLICKABLE_SCAN_INTERVAL_MS must fit in uint16_t.");
static constexpr const uint16_t CLICKABLE_SCAN_INTERVAL_MS =
...
#else
static_assert(CONFIG_CLICKABLE_LONG_CLICK_TIME_MS >= 0, "CONFIG_CLICKABLE_LONG_CLICK_TIME_MS must be non-negative.");
static_assert(CONFIG_CLICKABLE_LONG_CLICK_TIME_MS <= UINT16_MAX, "CONFIG_CLICKABLE_LONG_CLICK_TIME_MS must fit in uint16_t.");
...
#else
static_assert(CONFIG_CLICKABLE_SUPER_LONG_CLICK_TIME_MS >= 0, "CONFIG_CLICKABLE_SUPER_LONG_CLICK_TIME_MS must be non-negative.");
static_assert(CONFIG_CLICKABLE_SUPER_LONG_CLICK_TIME_MS <= UINT16_MAX, "CONFIG_CLICKABLE_SUPER_LONG_CLICK_TIME_MS must fit in uint16_t.");
static constexpr const uint16_t CLICKABLE_SUPER_LONG_CLICK_TIME_MS =
    CONFIG_CLICKABLE_SUPER_LONG_CLICK_TIME_MS;  //!< Clickable (button) long click time
...
#else
static_assert(CONFIG_DELAY_AFTER_RECEIVE_MS >= 0, "CONFIG_DELAY_AFTER_RECEIVE_MS must be non-negative.");
static_assert(CONFIG_DELAY_AFTER_RECEIVE_MS <= UINT8_MAX, "CONFIG_DELAY_AFTER_RECEIVE_MS must fit in uint8_t.");
...
#else
static_assert(CONFIG_NETWORK_CLICK_CHECK_INTERVAL_MS >= 0, "CONFIG_NETWORK_CLICK_CHECK_INTERVAL_MS must be non-negative.");
static_assert(CONFIG_NETWORK_CLICK_CHECK_INTERVAL_MS <= UINT8_MAX, "CONFIG_NETWORK_CLICK_CHECK_INTERVAL_MS must fit in uint8_t.");
static constexpr const uint8_t NETWORK_CLICK_CHECK_INTERVAL_MS =
    CONFIG_NETWORK_CLICK_CHECK_INTERVAL_MS;  //!< Network click check interval, in ms.
...
#else
static_assert(CONFIG_ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS > 0, "CONFIG_ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS must be greater than zero.");
static_assert(CONFIG_ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS <= UINT16_MAX,
              "CONFIG_ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS must fit in uint16_t.");
static constexpr const uint16_t ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS =
    CONFIG_ACTUATORS_AUTO_OFF_CHECK_INTERVAL_MS;  //!< Actuator auto off timer check interval, in ms.
...
#else
static_assert(CONFIG_LCNB_TIMEOUT_MS > 0, "CONFIG_LCNB_TIMEOUT_MS must be greater than zero.");
static_assert(CONFIG_LCNB_TIMEOUT_MS <= UINT16_MAX, "CONFIG_LCNB_TIMEOUT_MS must fit in uint16_t.");
...
#endif  // LSH_CORE_UTIL_CONSTANTS_TIMING_HPP
